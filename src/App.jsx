...
import './index.css'; 
import fotoPerfil from './assets/andrea.jpeg';
  ...
  return (
    <div className={`${temaEscuro ? 'dark-theme' : ''}`} style={{ minHeight: '100vh' }}>
      ...
      <main>
        ...
        <section id="sobre">
            <h2>Sobre Mim</h2>
           <img src={fotoPerfil} alt="Foto de Andréa" />
            <p>Estou cursando o curso de tecnologias em sistemas para internet.</p>
        </section>
      ...
      <footer>
        <p>&copy; 2026 - Desenvolvido por Andréa Nogueira</p>
      </footer>
    </div>
  );
}
